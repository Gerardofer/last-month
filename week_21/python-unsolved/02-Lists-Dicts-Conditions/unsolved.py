...
student_info['first_name'] = input('Please enter the student\'s first name. ')
student_info['last_name'] = input('Please enter the student\'s last name. ')
student_info['middle_initial'] = input('Please enter the student\'s middle initial. ')
student_info['address'] = input('Please enter the student\'s address. ')
student_info['email'] = input('Please enter the student\'s email. ')
student_info['phone_number'] = input('Please enter the student\'s phone_number. ')

# Print a separator...
print('-' * 18)

# Print all to the console...
print('The student\'s first name is {0}'.format(student_info["first_name"]))
print('The student\'s last name is {0}'.format(student_info["last_name"]))
print('The student\'s middle initial is {0}'.format(student_info["middle_initial"]))

print('The student\'s address is {0}'.format(student_info["address"]))
print('The student\'s email is {0}'.format(student_info["email"]))
print('The student\'s phone number is {0}'.format(student_info["phone_number"]))
