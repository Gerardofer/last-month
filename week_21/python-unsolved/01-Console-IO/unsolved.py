...
midlInit = input("What is your middle initial?: ")
address = input("and your address?: ")
email = input("and your email?: ")
phone = input("Lastly, what is your phone number?: ")

print("=" * 20)
print("Hello {0} {1}. {2}".format(firstName, midlInit, lastName))
print("Your address is: {0}".format(address))
print("And your email and phone number are: {0}, {1}".format(email, phone))
print("=" * 20)
